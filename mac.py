...
class DesinstaladorApp:
    ...
    def proceso_busqueda(self):
        self.rutas_encontradas = buscar_en_mac("League of Legends", self.actualizar_progreso)
...
def buscar_en_mac(nombre, callback):
    import time
    rutas = []
    if os.path.exists("/Applications/League of Legends.app"):
        rutas.append("/Applications/League of Legends.app")
        callback(100)
    return rutas
